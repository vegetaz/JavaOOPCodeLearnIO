...
- withdraw(amount: int) là phương thức dùng để rút tiền từ tài khoản 1 lượng có giá trị là amount (balance -= amount).
  Nếu số dư trong tài khoản không đủ (balance < amount) thì không thực hiện rút tiền và hiển thị ra màn hình:
    That amount exceeds your current balance.​
- display() là phương thức dùng để hiển thị ra màn hình thông tin tài khoản.
  Ví dụ nếu id = 1000, name = "Tuan", balance = 2490 thì khi gọi phương thức display() màn hình sẽ hiển thị ra:
    Id: 1000
    Name: Tuan
    Balance: 2490​
*/
public class Encapsulation28 {
